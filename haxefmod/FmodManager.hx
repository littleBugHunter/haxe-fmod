...
class FmodManager {
	...
	**/
	...
	/**
		...
		@see https://tanneris.me/FMOD-Macro-Controls
	**/
	public static function PlaySoundOneShotAtPosition(soundPath:String, position:Vector3D) {
		FmodManagerPrivate.GetInstance().PlaySoundOneShotAtPosition(soundPath, position);
	}
	...
	**/
	...
	/**
		...
		@param soundId Id of a loaded sound
	**/
	public static function ReleaseSoundWithoutStop(soundId:String) {
		FmodManagerPrivate.GetInstance().ReleaseSoundWithoutStop(soundId);
	}
